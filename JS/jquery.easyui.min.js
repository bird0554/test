...
if(opts.modal){
_27f.mask=$("<div class=\"window-mask\" style=\"display:none\"><iframe style=\"position:absolute;z-index:-1;width:100%;height:100%;top:0;left:0;scrolling:no;background:transparent;\" frameborder=\"0\"></iframe></div>").insertAfter(_27f.window);
}
if(_27f.shadow){
_27f.shadow.remove();
}
if(opts.shadow){
_27f.shadow=$("<div class=\"window-shadow\" style=\"display:none\"><iframe style=\"position:absolute;z-index:-1;width:100%;height:100%;top:0;left:0;scrolling:no;background:transparent;\" frameborder=\"0\"></iframe></div>").insertAfter(_27f.window);
}
...
var dlg=_2ad(opts);
return dlg;
},confirm:function(_2b3,msg,fn,fnclose){
...
/// <summary>zd：添加如果confirm点击了右上角的叉号，自动关闭调用fnclose方法功能</summary>
